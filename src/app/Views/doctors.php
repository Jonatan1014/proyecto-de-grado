                    ...
                    <div class="isotope-layout" data-default-filter="*" data-layout="masonry"
                        ...
                        <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-3.webp" class="img-fluid"
                                            alt="Dr. Amelia Brooks" loading="lazy">
                                    ...
                                    <div class="doctor-content">
                                        ...
                                        <p class="doctor-desc">Nostrud tempor magna minim excepteur, id cillum laboris
                                            aute proident.</p>
                            ...
                            <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-pediatrics">
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-7.webp" class="img-fluid"
                                            alt="Dr. Noah Turner" loading="lazy">
                                    </figure>
                                    <div class="doctor-content">
                            ...
                            <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-dermatology">
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-12.webp" class="img-fluid"
                                            alt="Dr. Sofia Bennett" loading="lazy">
                            ...
                            <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-cardiology">
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-10.webp" class="img-fluid"
                                            alt="Dr. Maya Patel" loading="lazy">
                                    </figure>
                                    <div class="doctor-content">
                                        <h3 class="doctor-name">Dr. Maya Patel</h3>
                                        <p class="doctor-title">Interventional Cardiologist • MD</p>
                                        <p class="doctor-desc">Cupidatat fugiat sint enim laboris, sed do ut aliquip
                                            dolor.</p>
                                        <div class="doctor-meta">
                                            <span class="badge dept">Cardiology</span>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-dermatology">
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-9.webp" class="img-fluid"
                                            alt="Dr. Harper Lane" loading="lazy">
                                    </figure>
                                    <div class="doctor-content">
                            ...
                            <div class="col-lg-3 col-md-6 doctor-item isotope-item filter-orthopedics">
                                <article class="doctor-card h-100">
                                    <figure class="doctor-media">
                                        <img src="assets/img/health/staff-6.webp" class="img-fluid"
                                            alt="Dr. Liam Carter" loading="lazy">
                                    </figure>
                                    <div class="doctor-content">
                        ...
                        <div class="col-lg-7" data-aos="fade-left" data-aos-delay="200">
                            <div class="profile-content">
                                ...
                                <p class="bio mb-3">Commodo incididunt aliqua minim, eiusmod in laboris nulla. Amet do
                                    occaecat quis, excepteur in magna id dolore incididunt. Tempor in aute ullamco,
                                    irure officia aliqua nostrud.</p>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    <a href="#" class="btn btn-appointment"><i class="bi bi-calendar2-check me-1"></i>
                                        Book Appointment</a>
                                    <a href="#" class="btn btn-soft"><i class="bi bi-file-earmark-text me-1"></i> View
                                        CV</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="100">
                            <div class="minimal-card text-center">
                                <img src="assets/img/health/staff-2.webp" alt="Dr. Oliver Hayes"
                        ...
                        <div class="col-6 col-md-4 col-lg-2" data-aos="fade-up" data-aos-delay="350">
                            <div class="minimal-card text-center">
                                <img src="assets/img/health/staff-11.webp" alt="Dr. Lucas Grant"
                                    class="avatar img-fluid" loading="lazy">
                                <div class="info">
                        ...
                        <div class="col-lg-8" data-aos="fade-left" data-aos-delay="200">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="health-doctors-3-tab-1" role="tabpanel">
                                    <p>Fugiat proident aliqua laboris, excepteur sunt ad pariatur occaecat. Veniam minim
                                        eu laboris, magna irure velit anim excepteur exercitation.</p>
                                    <ul class="list-unstyled mb-0">
                                        <li><i class="bi bi-check2-circle me-1"></i> Special interest in immunotherapy
                                        </li>

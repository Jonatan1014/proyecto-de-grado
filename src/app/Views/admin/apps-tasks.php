...
<head>
    ...
    <!-- Quill css -->
    <link href="assets/admin/assets/vendor/quill/quill.core.css" rel="stylesheet" type="text/css" />
    <link href="assets/admin/assets/vendor/quill/quill.bubble.css" rel="stylesheet" type="text/css" />
    <link href="assets/admin/assets/vendor/quill/quill.snow.css" rel="stylesheet" type="text/css" />
...
<body>
                                ...
                                <div class="page-title-right">
                                    <form>
                                        <div class="input-group">
                                            ...
                                            <button class="input-group-text btn btn-secondary dropdown-toggle"
                                            ...
                                            <div class="row justify-content-sm-between">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex justify-content-between">
                                                        <div>
                                                            <img src="assets/admin/assets/images/users/avatar-9.jpg"
                                                                alt="image" class="avatar-xs rounded-circle me-1"
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <ul class="list-inline font-13 text-end mb-0">
                                                                ...
                                                                <li class="list-inline-item ms-2">
                                                                    <span
                                                                        class="badge badge-info-lighten p-1">Medium</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div> <!-- end .d-flex-->
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <div>
                                                            <ul class="list-inline font-13 text-end">
                                                                ...
                                                                <li class="list-inline-item ms-2">
                                                                    <span
                                                                        class="badge badge-success-lighten p-1">Low</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div> <!-- end .d-flex-->
                                            ...
                                            <div class="row justify-content-sm-between mt-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex justify-content-between">
                                                        <div>
                                                            <img src="assets/admin/assets/images/users/avatar-7.jpg"
                                                                alt="image" class="avatar-xs rounded-circle me-1"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row justify-content-sm-between mt-2">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="d-flex justify-content-between">
                                                        <div>
                                                            <img src="assets/admin/assets/images/users/avatar-5.jpg"
                                                                alt="image" class="avatar-xs rounded-circle me-1"
                                                                data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        ...
                                                        <div>
                                                            <ul class="list-inline font-13 text-end mb-0">
                                                                <li class="list-inline-item">
                                                                    <i class='uil uil-schedule font-16 me-1'></i> 10 Sep
                                                                    3pm
                                                                </li>
                                                                <li class="list-inline-item ms-1">
                                        ...
                                        <div class="col">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col ps-0">
                                                            <a href="javascript:void(0);"
                                                                class="text-muted fw-bold">sales-assets/admin/assets.zip</a>
                                            ...
                                            <div class="card mb-2 shadow-none border">
                                                <div class="p-1">
                                                    <div class="row align-items-center">
                                                        <div class="col-auto">
                                                            <img src="assets/admin/assets/images/projects/project-1.jpg"
    ...
    <!-- Init js-->
    <script src="assets/admin/assets/js/pages/demo.tasks.js"></script>

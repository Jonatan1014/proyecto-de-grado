                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
                        <div class="department-item">
                            ...
                            <div class="department-image">
                                <img src="assets/img/health/cardiology-2.webp" alt="Cardiology Department"
                                    class="img-fluid">
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
                        <div class="department-item">
                            ...
                            <div class="department-image">
                                <img src="assets/img/health/neurology-3.webp" alt="Neurology Department"
                                    class="img-fluid">
                                <div class="department-overlay">
                                    <a href="#" class="department-link">
                                        <i class="fas fa-arrow-right"></i>
                        ...
                        <div class="department-item">
                            <div class="department-content">
                                ...
                                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt
                                    mollit anim id est laborum sed.</p>
                                <div class="department-features">
                            ...
                            <div class="department-image">
                                <img src="assets/img/health/pediatrics-2.webp" alt="Pediatrics Department"
                                    class="img-fluid">
                                <div class="department-overlay">
                                    <a href="#" class="department-link">
                                        <i class="fas fa-arrow-right"></i>
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="500">
                        <div class="department-item">
                            <div class="department-content">
                                ...
                                <p>Nulla facilisi morbi tempus iaculis urna id volutpat lacus laoreet non curabitur
                            ...
                            <div class="department-image">
                                <img src="assets/img/health/laboratory-3.webp" alt="Laboratory Department"
                                    class="img-fluid">
                                <div class="department-overlay">
                                    <a href="#" class="department-link">
                                        <i class="fas fa-arrow-right"></i>
                    ...
                    <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="600">
                        <div class="department-item">
                            <div class="department-content">
                                ...
                                <p>Convallis tellus id interdum velit laoreet id donec ultrices tincidunt arcu non
                                    sodales neque sodales ut etiam.</p>
                                <div class="department-features">
                            ...
                            <div class="department-image">
                                <img src="assets/img/health/emergency-4.webp" alt="Emergency Department"
                                    class="img-fluid">
                                <div class="department-overlay">
                                    <a href="#" class="department-link">
                                        <i class="fas fa-arrow-right"></i>

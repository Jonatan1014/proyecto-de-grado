...
class User {
     ...
     */
    public static function actualizar($usuarioId, $datos) {
        $db = Database::getConnection();
    ...
    /**
     * Verificar si un email está en uso por otro usuario
     */
    public static function emailEnUso($email, $usuarioId) {
        $db = Database::getConnection();
     ...
     */
    public static function verificarPassword($usuarioId, $password) {
        $db = Database::getConnection();
     ...
     */
    public static function actualizarPassword($usuarioId, $nuevaPassword) {
        $db = Database::getConnection();
